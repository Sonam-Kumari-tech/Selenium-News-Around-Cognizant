...
public class TestClass {
	...
	public void validateUser() throws InterruptedException, IOException 
	{
		...
		//validation
		Assert.assertEquals(Name,"Kumari, Sonam (Contractor)");
		Assert.assertEquals(Email,"2320195@cognizant.com");
	}
	...
	WebElement newsSection =driver.findElement(By.xpath("//*[@id=\"CaptionElementView\"]"));
		Sr.Scroll(newsSection);
		Thread.sleep(3000);
		List<WebElement> CountNews = Fp.FirstNews();
		System.out.println("News present in first page are : ");
		for(int i =5;i<CountNews.size();i++) 
		{
